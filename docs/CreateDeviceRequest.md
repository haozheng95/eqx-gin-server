...
`func NewCreateDeviceRequest(metro string, operatingSystem string, plan string, facility CreateDeviceRequestOneOf1AllOfFacility, ) *CreateDeviceRequest`
...
`func (o *CreateDeviceRequest) GetCustomdata() interface{}`

GetCustomdata returns the Customdata field if non-nil, zero value otherwise.

### GetCustomdataOk

`func (o *CreateDeviceRequest) GetCustomdataOk() (*interface{}, bool)`
...
`func (o *CreateDeviceRequest) SetCustomdata(v interface{})`
...
`func (o *CreateDeviceRequest) SetCustomdataNil(b bool)`

 SetCustomdataNil sets the value for Customdata to be an explicit nil

### UnsetCustomdata
`func (o *CreateDeviceRequest) UnsetCustomdata()`
...
`func (o *CreateDeviceRequest) GetIpAddresses() []CreateDeviceRequestOneOfAllOf1IpAddressesInner`

GetIpAddresses returns the IpAddresses field if non-nil, zero value otherwise.

### GetIpAddressesOk

`func (o *CreateDeviceRequest) GetIpAddressesOk() (*[]CreateDeviceRequestOneOfAllOf1IpAddressesInner, bool)`
...
`func (o *CreateDeviceRequest) SetIpAddresses(v []CreateDeviceRequestOneOfAllOf1IpAddressesInner)`
...
`func (o *CreateDeviceRequest) GetSshKeys() []CreateDeviceRequestOneOfAllOf1SshKeysInner`

GetSshKeys returns the SshKeys field if non-nil, zero value otherwise.

### GetSshKeysOk

`func (o *CreateDeviceRequest) GetSshKeysOk() (*[]CreateDeviceRequestOneOfAllOf1SshKeysInner, bool)`
...
`func (o *CreateDeviceRequest) SetSshKeys(v []CreateDeviceRequestOneOfAllOf1SshKeysInner)`
...
`func (o *CreateDeviceRequest) GetFacility() CreateDeviceRequestOneOf1AllOfFacility`

GetFacility returns the Facility field if non-nil, zero value otherwise.

### GetFacilityOk

`func (o *CreateDeviceRequest) GetFacilityOk() (*CreateDeviceRequestOneOf1AllOfFacility, bool)`
...
`func (o *CreateDeviceRequest) SetFacility(v CreateDeviceRequestOneOf1AllOfFacility)`
