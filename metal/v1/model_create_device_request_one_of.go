...
func NewCreateDeviceRequestOneOf(metro string, operatingSystem string, plan string) *CreateDeviceRequestOneOf {
	this := CreateDeviceRequestOneOf{}
	this.Metro = metro
	//var alwaysPxe bool = true
...
type NullableCreateDeviceRequestOneOf struct {
	value *CreateDeviceRequestOneOf
	isSet bool
}

func (v NullableCreateDeviceRequestOneOf) Get() *CreateDeviceRequestOneOf {
	return v.value
}

func (v *NullableCreateDeviceRequestOneOf) Set(val *CreateDeviceRequestOneOf) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateDeviceRequestOneOf) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateDeviceRequestOneOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateDeviceRequestOneOf(val *CreateDeviceRequestOneOf) *NullableCreateDeviceRequestOneOf {
	return &NullableCreateDeviceRequestOneOf{value: val, isSet: true}
}
