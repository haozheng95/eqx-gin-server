...
func NewFindMetalGatewayById200ResponseOneOf() *FindMetalGatewayById200ResponseOneOf {
	this := FindMetalGatewayById200ResponseOneOf{}
	return &this
}
...
type NullableFindMetalGatewayById200ResponseOneOf struct {
	value *FindMetalGatewayById200ResponseOneOf
	isSet bool
}

func (v NullableFindMetalGatewayById200ResponseOneOf) Get() *FindMetalGatewayById200ResponseOneOf {
	return v.value
}

func (v *NullableFindMetalGatewayById200ResponseOneOf) Set(val *FindMetalGatewayById200ResponseOneOf) {
	v.value = val
	v.isSet = true
}

func (v NullableFindMetalGatewayById200ResponseOneOf) IsSet() bool {
	return v.isSet
}

func (v *NullableFindMetalGatewayById200ResponseOneOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFindMetalGatewayById200ResponseOneOf(val *FindMetalGatewayById200ResponseOneOf) *NullableFindMetalGatewayById200ResponseOneOf {
	return &NullableFindMetalGatewayById200ResponseOneOf{value: val, isSet: true}
}

func (v NullableFindMetalGatewayById200ResponseOneOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFindMetalGatewayById200ResponseOneOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
