...
func NewFindDeviceById200ResponseNetworkPortsInnerNativeVirtualNetworkMetalGatewaysInner() *FindDeviceById200ResponseNetworkPortsInnerNativeVirtualNetworkMetalGatewaysInner {
	this := FindDeviceById200ResponseNetworkPortsInnerNativeVirtualNetworkMetalGatewaysInner{}
	return &this
}
...
func (o *FindDeviceById200ResponseNetworkPortsInnerNativeVirtualNetworkMetalGatewaysInner) GetVlan() float32 {
	if o == nil || o.Vlan == nil {
		var ret float32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *FindDeviceById200ResponseNetworkPortsInnerNativeVirtualNetworkMetalGatewaysInner) GetVlanOk() (*float32, bool) {
	if o == nil || o.Vlan == nil {
		return nil, false
	}
	return o.Vlan, true
...
func (o *FindDeviceById200ResponseNetworkPortsInnerNativeVirtualNetworkMetalGatewaysInner) SetVlan(v float32) {
	o.Vlan = &v
}

func (o FindDeviceById200ResponseNetworkPortsInnerNativeVirtualNetworkMetalGatewaysInner) MarshalJSON() ([]byte, error) {
...
type NullableFindDeviceById200ResponseNetworkPortsInnerNativeVirtualNetworkMetalGatewaysInner struct {
	value *FindDeviceById200ResponseNetworkPortsInnerNativeVirtualNetworkMetalGatewaysInner
	isSet bool
}

func (v NullableFindDeviceById200ResponseNetworkPortsInnerNativeVirtualNetworkMetalGatewaysInner) Get() *FindDeviceById200ResponseNetworkPortsInnerNativeVirtualNetworkMetalGatewaysInner {
	return v.value
}

func (v *NullableFindDeviceById200ResponseNetworkPortsInnerNativeVirtualNetworkMetalGatewaysInner) Set(val *FindDeviceById200ResponseNetworkPortsInnerNativeVirtualNetworkMetalGatewaysInner) {
	v.value = val
	v.isSet = true
}

func (v NullableFindDeviceById200ResponseNetworkPortsInnerNativeVirtualNetworkMetalGatewaysInner) IsSet() bool {
	return v.isSet
}

func (v *NullableFindDeviceById200ResponseNetworkPortsInnerNativeVirtualNetworkMetalGatewaysInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFindDeviceById200ResponseNetworkPortsInnerNativeVirtualNetworkMetalGatewaysInner(val *FindDeviceById200ResponseNetworkPortsInnerNativeVirtualNetworkMetalGatewaysInner) *NullableFindDeviceById200ResponseNetworkPortsInnerNativeVirtualNetworkMetalGatewaysInner {
	return &NullableFindDeviceById200ResponseNetworkPortsInnerNativeVirtualNetworkMetalGatewaysInner{value: val, isSet: true}
}

func (v NullableFindDeviceById200ResponseNetworkPortsInnerNativeVirtualNetworkMetalGatewaysInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFindDeviceById200ResponseNetworkPortsInnerNativeVirtualNetworkMetalGatewaysInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
