...
func (o *DeviceCreateInMetroInput) GetIpAddresses() []CreateDeviceRequestOneOfAllOf1IpAddressesInner {
...
// and a boolean to check if the value has been set.
func (o *DeviceCreateInMetroInput) GetIpAddressesOk() ([]CreateDeviceRequestOneOfAllOf1IpAddressesInner, bool) {
	if o == nil || o.IpAddresses == nil {
		return nil, false
	}
...
func (o *DeviceCreateInMetroInput) SetIpAddresses(v []CreateDeviceRequestOneOfAllOf1IpAddressesInner) {
	o.IpAddresses = v
}
...
func (o *DeviceCreateInMetroInput) GetSshKeys() []CreateDeviceRequestOneOfAllOf1SshKeysInner {
...
// and a boolean to check if the value has been set.
func (o *DeviceCreateInMetroInput) GetSshKeysOk() ([]CreateDeviceRequestOneOfAllOf1SshKeysInner, bool) {
	if o == nil || o.SshKeys == nil {
		return nil, false
	}
...
func (o *DeviceCreateInMetroInput) SetSshKeys(v []CreateDeviceRequestOneOfAllOf1SshKeysInner) {
	o.SshKeys = v
}
...
type NullableDeviceCreateInMetroInput struct {
	value *DeviceCreateInMetroInput
	isSet bool
}

func (v NullableDeviceCreateInMetroInput) Get() *DeviceCreateInMetroInput {
	return v.value
}

func (v *NullableDeviceCreateInMetroInput) Set(val *DeviceCreateInMetroInput) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceCreateInMetroInput) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceCreateInMetroInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceCreateInMetroInput(val *DeviceCreateInMetroInput) *NullableDeviceCreateInMetroInput {
	return &NullableDeviceCreateInMetroInput{value: val, isSet: true}
}
